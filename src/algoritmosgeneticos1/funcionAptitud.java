...
public class funcionAptitud extends FitnessFunction {
    ...
    private void Evaluar(IChromosome cromosoma) {
       ...
       // Integer valorYdecimal = (Integer.parseInt(valorYDec, 2));
        ...
        double valor= -191739 + ((0.2585*Math.pow(valorXFinal,6)) + (Math.pow(valorXFinal,5) *(-19.338)) + (562.55 * Math.pow(valorXFinal,4)) + (Math.pow(valorXFinal,3) *(-7979.2)) + (56266 *Math.pow(valorXFinal ,2)) - (171797 * valorXFinal) - 8038.4 );
        ...
        if(Double.isNaN(valor)){
            ...
            fitness =  -191739 + ((0.2585*Math.pow(valorXFinal,6)) + (Math.pow(valorXFinal,5) *(-19.338)) + (562.55 * Math.pow(valorXFinal,4)) + (Math.pow(valorXFinal,3) *(-7979.2)) + (56266 *Math.pow(valorXFinal ,2)) - (171797 * valorXFinal) - 8038.4 );
